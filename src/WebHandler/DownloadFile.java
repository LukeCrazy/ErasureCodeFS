        ...
        try{
            for(FileInfo item:fileList){
                ...
                if(item.getFileName().equals(fileName) && item.getUserName().equals(count)){
                    optInfo = new OptInfo(fileName,  item.getFileSize(), count, "", "download", time, "", "",0);
                    ...
                    switch(algName){
                        case "replication":
                            Replication rpl = new Replication(algInfo.getParamK(), item, fop,targetFile.getLogicBlockSize());
                            ...
                            break;
                        case "EVENODD":
                            EVENODD evenodd = new EVENODD(algInfo.getParamK(), item, fop,targetFile.getLogicBlockSize());
                        ...
                        case "LREVENODD":
                            ...
                            LREVENODD lrevenodd = new LREVENODD(algInfo.getParamK(), item, fop,targetFile.getLogicBlockSize());
                            ...
                            break;
                        case "RDP":
                            RDP rdp = new RDP(algInfo.getParamK(), item, fop,targetFile.getLogicBlockSize());
                            ...
                            break;
                        case "LRRDP":
                            LRRDP lrrdp = new LRRDP(algInfo.getParamK(), item, fop,targetFile.getLogicBlockSize());
